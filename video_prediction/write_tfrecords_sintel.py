...
def convert_to(input_tuple):
  ...
  for file_name in file_names:
    image1_file, image2_file, scene, file_no = file_name
...
def main(unused_argv):
  data_dir = "/home/wangyang59/Data/mpi-sintel/test"
  ...
  for i in range(n/batch_size + 1):
    output_file = "/home/wangyang59/Data/ILSVRC2016_tf_sintel_clean_test_hist/%s.tfrecord" % i
