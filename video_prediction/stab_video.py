...
def main():
  data_dir = '/home/wangyang59/Data/ILSVRC2016/Data/VID/snippets/train/ILSVRC2015_VID_train_0002/'
...
#     convert_to(os.path.join(h5_dir, h5_file), "/home/wangyang59/Data/ILSVRC2016_tf/train")
  ...
  fun = functools.partial(stablize, "/home/wangyang59/Data/ILSVRC2016_stab/train2/")
  pool = multiprocessing.Pool(20)
  pool.imap_unordered(fun, [os.path.join(data_dir, video_file) for video_file in video_files], chunksize=10)
  pool.close()
  pool.join()

  data_dir = '/home/wangyang59/Data/ILSVRC2016/Data/VID/snippets/train/ILSVRC2015_VID_train_0003/'
  video_files = os.listdir(data_dir)
